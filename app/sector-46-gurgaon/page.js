...
import { galleryImages, amenityImages } from '../../lib/sector-46-gurgaon/images'

import Navbar from '../../components/sector-46-gurgaon/Navbar'
import Hero from '../../components/sector-46-gurgaon/Hero'

const Overview = dynamic(() => import('../../components/sector-46-gurgaon/Overview'), { ssr: true })
const Projects = dynamic(() => import('../../components/sector-46-gurgaon/Projects'), { ssr: true })
const Highlights = dynamic(() => import('../../components/sector-46-gurgaon/Highlights'), { ssr: true })
const Amenities = dynamic(() => import('../../components/sector-46-gurgaon/Amenities'), { ssr: true })
const Pricing = dynamic(() => import('../../components/sector-46-gurgaon/Pricing'), { ssr: true })
const Location = dynamic(() => import('../../components/sector-46-gurgaon/Location'), { ssr: true })
const MasterPlan = dynamic(() => import('../../components/sector-46-gurgaon/MasterPlan'), { ssr: true })
// const PaymentPlan = dynamic(() => import('../../components/sector-46-gurgaon/PaymentPlan'), { ssr: true })
const AboutDeveloper = dynamic(() => import('../../components/sector-46-gurgaon/AboutDeveloper'), { ssr: true })
const QuickChat = dynamic(() => import('../../components/sector-46-gurgaon/QuickChat'), { ssr: true })
const Footer = dynamic(() => import('../../components/sector-46-gurgaon/Footer'), { ssr: true })

const Gallery = dynamic(() => import('../../components/sector-46-gurgaon/Gallery'), { ssr: false })
// const VirtualTour = dynamic(() => import('../../components/sector-46-gurgaon/VirtualTour'), { ssr: false })
const CarouselSection = dynamic(() => import('../../components/sector-46-gurgaon/CarouselSection'), { ssr: false })
// const ExclusiveAmenities = dynamic(() => import('../../components/sector-46-gurgaon/ExclusiveAmenities'), { ssr: false })
// const Sustainability = dynamic(() => import('../../components/sector-46-gurgaon/Sustainability'), { ssr: false })
// const JapaneseExcellence = dynamic(() => import('../../components/sector-46-gurgaon/JapaneseExcellence'), { ssr: false })
const EnquireModal = dynamic(() => import('../../components/sector-46-gurgaon/EnquireModal'), { ssr: false })
const AosInit = dynamic(() => import('../../components/sector-46-gurgaon/AosInit'), { ssr: false })
