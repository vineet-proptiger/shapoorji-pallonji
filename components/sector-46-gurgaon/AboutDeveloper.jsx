...
const AboutDeveloper = ({ setIsOpen }) => (
  <section id="developer" className="py-16 sm:py-20 relative bg-fixed bg-cover bg-center border-b border-gray-100" style={{ backgroundImage: 'url(/sector-46-gurgaon/images/about-devloper/about-dev.webp)' }}>
