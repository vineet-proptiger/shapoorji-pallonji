...
const ContactCTA = () => {
  ...
  return (
    <section id="contact" className="relative py-20 bg-fixed bg-cover bg-center" style={{ backgroundImage: 'url(/sector-46-gurgaon/images/Enquiry/enquiry.webp)' }}>
            ...
            {success ? (
              ...
              <form onSubmit={submit} className="flex flex-col gap-6">
                ...
                <button type="submit" disabled={loading}
                  className="w-full py-4 mt-2 text-sm font-bold tracking-widest uppercase transition-all duration-300 rounded-lg bg-[#CA6A27] text-white hover:bg-[#b3581e]"
                  style={{ fontFamily: F_SANS }}>
