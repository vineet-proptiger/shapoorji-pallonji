...
import { heroImages } from '../../lib/sector-46-gurgaon/images'
    ...
    <section className="hero-container">
      <style dangerouslySetInnerHTML={{ __html: `
        .hero-container {
          ...
          height: auto;
          overflow: hidden;
          background-image: url('/sector-46-gurgaon/images/hero/banner1.webp');
      ...
      <div className="hero-slider-wrapper hidden md:grid">
        {slides.map((slide, index) => (
          ...
          >
            <Image
              src={slide.img}
              alt={`Shapoorji Pallonji Dualis Banner ${index + 1}`}
              width={1920}
              height={800}
      ...
      <div className="hero-content">
        ...
        <p className="hero-subtitle">
          <span style={{ fontSize: '0.9em', fontWeight: 600, textTransform: 'none', color: '#fff' }}>AT SECTOR 46, GURGAON</span>
        </p>
